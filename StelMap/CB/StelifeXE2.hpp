...
// (DO NOT EDIT: machine generated header) 'StelifeXE2.pas' rev: 23.00 (Win32)

#ifndef Stelifexe2HPP
#define Stelifexe2HPP
...
#include <stelmap.hpp>	// Pascal unit
#include <tileosm.hpp>	// Pascal unit
...
namespace Stelifexe2
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Stelifexe2 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STELIFEXE2)
using namespace Stelifexe2;
#endif
#pragma pack(pop)
#pragma option pop
